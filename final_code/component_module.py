...
class Component:
    def __init__(self, name, list_position,  df_orig, min_value=None, max_value=None, step_size=None, correlation_dict=None, p_value_dict=None,
                 non_lin_correlation_dict=None, non_lin_p_value_dict=None, mutual_info_dict=None, wave_diff_dict=None, change_ratio=None, norm_step_size=None ):
        self.name = name
        ...
        self.min_value, self.max_value, self.step_size, self.norm_step_size, self.change_ratio = self.calculate_min_max_step_size(df_orig)
    ...
    def calculate_min_max_step_size(self, df):
        ...
        if self.name in df.columns:
            ...
            return min_value, max_value, step_size, norm_step_size, change_ratio
        else:
